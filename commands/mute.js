...
user.send(`<:muted:585767366722584576>**|** EI! **parado ae** você foi mutado no servidor \`${servermuted}\` por que \`${reason}\` quem mandou não ver as regras em!?`)
}
...
${message.mentions.users.first().username}
    ...
    if(!reason) {
      return message.channel.send(` ${message.author} porfavor use uma rasão para o usuário mutar!`)
    }
