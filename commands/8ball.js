...
exports.run = async (bot, message, args) => {
   ...
   var list = ["Sim", "Não", "Eu não sei", "Pergunte novamente mais tarde!", "Não tenho certeza!", "Pfv Não", "Diz-me tu", "Sem duvida", "Não posso prever agora", "Sem duvida","Melhor você não saber"];
